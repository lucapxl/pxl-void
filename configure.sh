...
PACKAGES=" $PACKAGES foot Thunar thunar-archive-plugin thunar-volman xarchiver tumbler galculator eom"  # terminal, file manager, flatpak calculator and image viewer
